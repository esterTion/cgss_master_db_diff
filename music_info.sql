...
INSERT INTO `music_info` VALUES (/*id*/1043, /*discription*/"高垣楓（CV：早見沙織）\n本田未央（CV：原紗友里）\n佐久間まゆ（CV：牧野由依）\n\n\n作詞：森由⾥⼦\n作曲・編曲：石濱翔（MONACA）");
INSERT INTO `music_info` VALUES (/*id*/1044, /*discription*/"本田未央（CV：原紗友里）\n龍崎薫（CV：春瀬なつみ）\n喜多見柚（CV：武田羅梨沙多胡）\n\n\n作詞・作曲・編曲：宮崎誠");
INSERT INTO `music_info` VALUES (/*id*/1045, /*discription*/"五十嵐響子（CV：種﨑敦美）\nアナスタシア（CV：上坂すみれ）\n依田芳乃（CV：高田憂希）\n\n\n作詞：森由里子\n作曲・編曲：田中秀和（MONACA）");
INSERT INTO `music_info` VALUES (/*id*/1046, /*discription*/"関裕美（CV：会沢紗弥）\n水本ゆかり（CV：藤田茜）\n棟方愛海（CV：藤本彩花）\n\n\n作詞・作曲・編曲：田村歩美");
...
INSERT INTO `music_info` VALUES (/*id*/3047, /*discription*/"松永涼（CV：千菅春香）\n\n\n作詞：ミズノゲンキ\n作曲：根本優樹\n編曲：R・O・N\nインストゥルメンツ：R・O・N");
INSERT INTO `music_info` VALUES (/*id*/3048, /*discription*/"依田芳乃（CV：高田憂希）\n\n\n作詞・作曲・編曲：BNSI（トリ音）\nギター：前原孝紀\nストリングス：友馬ストリングス");
...
INSERT INTO `music_info` VALUES (/*id*/5014, /*discription*/"CANDY ISLAND with 輿水幸子\n\n双葉杏（CV：五十嵐裕美）\n三村かな子（CV：大坪由佳）\n緒方智絵里（CV：大空直美）\n輿水幸子（CV：竹達彩奈）\n\n\n作詞：磯谷佳江\n作曲：小野貴光\n編曲：玉木千尋");
