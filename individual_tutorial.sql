...
INSERT INTO `individual_tutorial` VALUES (/*id*/20098, /*img*/1, /*discription*/"「ゴキゲンParty Night -Dance!!!!!!!!!!!!!!! Remix-」\n「Noctorne ～For SS3A rearrange Mix～」\nをサウンドブースで販売開始しました !\n※本楽曲のLIVE演出は、2D標準・2D軽量のみとなります。");
INSERT INTO `individual_tutorial` VALUES (/*id*/20099, /*img*/1, /*discription*/"ニコニコ生放送「デレステNIGHT★×19」にて、\n制作が決定した「おめんやさん」が登場 ! !");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/30099, /*img*/1, /*discription*/"「3周年記念スペシャルLIVEキャンペーン」\n開催中 ! 期間中にLIVEをクリアすると、\n期間限定のアイテムを獲得できます !");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/80003, /*img*/5, /*discription*/"通常楽曲とイベント限定営業でミステリアスアイズエンブレムを\n集め、イベント楽曲で大量にptを獲得しましょう。\nランキング入賞を目指して頑張りましょう。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80003, /*img*/6, /*discription*/"ミステリアスアイズエンブレム消費数を2倍、または4倍に\n設定することができます。\n消費数に応じて、イベントptを多く獲得できます。");
