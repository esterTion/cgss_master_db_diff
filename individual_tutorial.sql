...
INSERT INTO `individual_tutorial` VALUES (/*id*/20299, /*img*/1, /*discription*/"「ゴールデンウィーク\nマニー獲得キャンペーン」開催中 ! ! キャンペーン中は、\nたくさんのマニーが獲得できるスペシャル営業が\n1日1回行えます !");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/80001, /*img*/3, /*discription*/"通常楽曲とイベント限定営業をプレイすると、\nホシヨミキサーとイベントptを獲得できます。\nホシヨミキサーは、スタミナ消費量と\nSCOREランクが高いほど多く獲得できます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80001, /*img*/4, /*discription*/"イベント楽曲は、ホシヨミキサーを消費してプレイします。\nホシヨミキサー消費倍率に応じて通常楽曲よりもイベントptを多く獲得できます。\nイベント楽曲は、イベント期間中のみプレイできます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80001, /*img*/5, /*discription*/"通常楽曲とイベント限定営業でホシヨミキサーを\n集め、イベント楽曲で大量にptを獲得しましょう。\nランキング入賞を目指して頑張りましょう。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/80003, /*img*/4, /*discription*/"イベント楽曲は、ホシヨミキサーを消費してプレイします。\nホシヨミキサー消費倍率に応じて通常楽曲よりもイベントptを多く獲得できます。\nイベント楽曲は、イベント期間中のみプレイできます。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/2, /*discription*/"今回のイベントではイベントpt報酬として「イベント楽曲の歌唱アイドル」が\n着用可能な衣装、「ホーリーナイト・ロマンス」が獲得できます !\n※「ホーリーナイト・ロマンス」は、今後別の方法でも\n獲得可能になる予定です。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/3, /*discription*/"まずは育成する「マイスタイルアイドル」を選択して\nタワーに挑戦しましょう。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/3, /*discription*/"「マイスタイルアイドル」はタワーのフロア課題を達成していくことで、\n育成ptによって各ステータスが上昇したり、\nレアリティやスターランクがアップしていく特別なアイドルです。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/3, /*discription*/"過去のイベントで育成したことがあるマイスタイルアイドルも\n獲得が可能です。加入済みのアイドルと同じアイドルを選択すると、\n新たに別のマイスタイルアイドルとして加入します。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/4, /*discription*/"育成ptは、特定のフロアの課題達成で獲得できます。\n育成ptには「ボーカルpt」「ダンスpt」「ビジュアルpt」「ライフpt」\nがあり、獲得したptの種類によって、マイスタイルアイドルの\nステータスが成長します。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/4, /*discription*/"メインタワーには育成pt以外にも\n「レアリティアップ」「スターランクアップ」が獲得できるフロアがあり、\nマイスタイルアイドルのレアリティやスターランクが成長します。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/4, /*discription*/"メインタワーのフロア課題を達成していくと、\n新しいタワーやフロアが解放されます。\nタワーごとに獲得できる育成ptなどに特色があるので、\nアイドルの育成方針にあわせて挑戦するタワーを選びましょう。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/5, /*discription*/"マイスタイルアイドルは、本イベント内でのみ育成できます。\nまた、次回の同イベント開催時には育成状況を引き継ぐことができます。\n※本イベント開催期間外でも、通常のLIVEや他イベントでの\n編成は可能です。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/6, /*discription*/"過去のイベントで育成したマイスタイルアイドルは、\nアイドル選択画面にて、そのアイドルを育成した\n開催回を選択することで表示できます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/7, /*discription*/"「マイスタイルアイドル」は専用アイテム「バッジ」を使用することで、\n自分の好きなセンター効果や特技を習得できます。\n※バッジはマイスタイルアイドルの詳細画面から使用できます。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/7, /*discription*/"バッジは、フロアの課題クリア報酬やイベントpt報酬、\nアイドルpt報酬で獲得できます。\n※バッジはプレゼントに送られず、直接獲得できます。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/8, /*discription*/"「マイスタイルアイドル」の見た目は、自分のアルバムに\n登録されているアイドルの中から選択できます。またフレーズ名や特技名も変更できます。\n※見た目、フレーズ名、特技名はマイスタイルアイドルの詳細画面\nから変更できます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/9, /*discription*/"「イベントpt」はイベント開催期間中に\nLIVEやイベント限定営業、「LIVE PARTY!!」を\n行うことで獲得できます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/9, /*discription*/"「アイドルpt」は育成アイドルごとに獲得できるptです。\nイベントptと同様、LIVEやイベント限定営業、「LIVE PARTY!!」を\n行うことで、タワーを進行中のアイドルのptを獲得できます。\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/10, /*discription*/"メインタワーの50階をクリアすると、\nアイドルごとのイベント限定称号が獲得できます。\n※称号の獲得は各アイドルごとに1度までです");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/11, /*discription*/"今回のイベントで獲得できる報酬の一部をご紹介します !\n「Myスターレッスントレーナーチケット」\nセンター効果バッジ「トリコロール・ステップ」「シンデレラチャーム」\n「パッション・クロス・キュート」「キュート・クロス・パッション」\n");
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/11, /*discription*/"特技バッジ「コーディネイト」「オールラウンド」\n「スライドアクト」「コンセントレーション」\n※獲得できるバッジはイベント開催ごとに異なり、\n次回開催時には獲得できない場合があります。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/81001, /*img*/6, /*discription*/"イベントptは、イベント専用の「プロデュース編成」により編成ボーナスが発生します。\n編成したアイドルの「スターランクの合計値」が高いほどイベントptの獲得量がアップします。\nまた、一部アイドルはイベント編成にてスターランク値がアップします。\n※スターランク値アップの対象アイドルはお知らせからご確認いただけます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/81001, /*img*/6, /*discription*/"アイドルptは、2種類のボーナスにより獲得量がアップします。\n「絆Lvボーナス」は、プロデュースしたアイドルの絆Lvが高いほど獲得量がアップします。\n「アルバムボーナス」は、プロデュースした\nアイドルのアルバム登録数が多いほど獲得量がアップします。");
INSERT INTO `individual_tutorial` VALUES (/*id*/81001, /*img*/7, /*discription*/"「イベントpt」、「アイドルpt」はイベント開催期間中に\nLIVEやイベント限定営業、「LIVE PARTY!!」を\n行うことで獲得できます。");
INSERT INTO `individual_tutorial` VALUES (/*id*/81001, /*img*/8, /*discription*/"アイプロ応援セットは期間限定販売です。\n購入すると「プラチナ10連ガシャチケット」を1枚、\n「高級プロデュースギフト」を30個、");
INSERT INTO `individual_tutorial` VALUES (/*id*/81001, /*img*/8, /*discription*/"「スタミナドリンク50」を3個獲得できます。\n※有償スタージュエルでのみ購入することができます。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/81002, /*img*/2, /*discription*/"※イベント終了日時である「4月28日 20:59」まで使用が可能です。\n※使用しきれなかった「高級プロデュースギフト」は\nイベント結果発表のタイミングで、\n「スタミナドリンク10」に変換され、プレゼントに贈られます。");
