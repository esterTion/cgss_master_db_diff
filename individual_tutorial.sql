...
INSERT INTO `individual_tutorial` VALUES (/*id*/80901, /*img*/10, /*discription*/"特技バッジ「ライフスパークル」「オールラウンド」\n「フリックアクト」「コンセントレーション」\n※獲得できるバッジはイベント開催ごとに異なり、\n次回開催時には獲得できない場合があります。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/91001, /*img*/1, /*discription*/"新機能「ロケ撮」近日公開予定 ! \n様々なロケーションでアイドルの撮影が楽しめます !");
