...
INSERT INTO `individual_tutorial` VALUES (/*id*/80003, /*img*/5, /*discription*/"通常楽曲とイベント限定営業でドリームアウェイエンブレムを\n集め、イベント楽曲で大量にptを獲得しましょう。\nランキング入賞を目指して頑張りましょう。");
INSERT INTO `individual_tutorial` VALUES (/*id*/80003, /*img*/6, /*discription*/"ドリームアウェイエンブレム消費数を2倍、または4倍に\n設定することができます。\n消費数に応じて、イベントptを多く獲得できます。");
