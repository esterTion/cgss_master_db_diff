...
INSERT INTO `individual_tutorial` VALUES (/*id*/20098, /*img*/1, /*discription*/"「ハロウィンサーカス」をテーマにしたアイテムとコーデが登場 !\n愉快で妖しげなサーカステントで、ハロウィンナイトを楽しみましょう !");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/20299, /*img*/1, /*discription*/"「ハロー ! ハロウィン ! 親愛度アップキャンペーン」開催中 ! !\nキャンペーン中は、必ず複数のギフトアイテムが獲得できる\nスペシャル営業を3種類追加 !\n詳細はお知らせよりご確認ください。");
...
INSERT INTO `individual_tutorial` VALUES (/*id*/30099, /*img*/1, /*discription*/"「MOTTO ! Motto ! \nスペシャルLIVEキャンペーン」開催中 ! !\n期間中にクリアしたLIVEでは、期間限定のアイテムと\n今まで出現した限定トレチケを獲得できます !");
INSERT INTO `individual_tutorial` VALUES (/*id*/30099, /*img*/2, /*discription*/"「MOTTO ! Motto ! \n特訓支援キャンペーン」開催中 ! ! キャンペーン中は、\nLIVE成功時のティアラと魔法のドレスのドロップ率が\nさらにアップします ! 詳細はお知らせよりご確認ください。");
